  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        // Extract the admin's information from the response
        const adminData = {
        ...
        await AsyncStorage.setItem('adminToken', response.data.data.accessToken);
        await AsyncStorage.setItem('adminRefreshToken', response.data.data.refreshToken);
        ...
        // Navigate to AdminDashboard with admin data
        setTimeout(() => 
            ...
            <View className="flex-1 justify-center items-center px-6 py-12">
              <View className="w-full max-w-md bg-white/20 backdrop-blur-lg p-8 rounded-2xl shadow-lg border border-white/30">
                <View className="items-center mb-6">
                  ...
                  <Text className="text-white text-3xl font-bold">Admin Login</Text>
                  <Text className="text-white/80 mt-2">Enter your admin credentials</Text>
                </View>
